...
const config: Config = {
  ...
  themeConfig: {
    // Project social card removed (no static images present)
    colorMode: {
    ...
    footer: {
      style: 'dark',
      links: [],
      copyright: `Copyright © ${new Date().getFullYear()} Tech Made Easy. Contact: contact@katk.dev. Project funded by Loch Long Jetty Association.`,
    },
    prism: {
